...
namespace PayLend.Repository.IdentityRpository
{

    public class IdentityRpository<TContext> : IIdentityRepository, IDisposable where TContext : DbContext
    {
        protected readonly TContext context;

        public IdentityRpository(TContext _context)
        {
            context = _context;
        }
        ...
        IQueryable<T> IIdentityRepository.FindById<T>(Expression<Func<T, bool>> filter, bool NoTracking)
        {
